...
class EditBusinessUseCase @Inject constructor(private val repository: BusinessRepository) {
    suspend operator fun invoke(business: BusinessModel): Result<Unit> = repository.updateBusiness(business)
}