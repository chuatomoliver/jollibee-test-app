...
class GetOpenTaskUseCase @Inject constructor(private val repository: TaskRepository) {
    operator fun invoke(): Flow<Result<List<TaskModel>>> = repository.getAllOpenTasks()
}